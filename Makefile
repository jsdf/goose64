...
CODEFILES   = 	main.c stage00.c graphic.c gfxinit.c om_mem_heap.c vec3d.c vec2d.c gameobject.c game.c modeltype.c renderer.c input.c character.c player.c gameutils.c item.c
